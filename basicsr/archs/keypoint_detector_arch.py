...
from basicsr.utils.motion_estimator_util import Hourglass, make_coordinate_grid, AntiAliasInterpolation2d
import pdb
...
class KPDetector(nn.Module):
    ...
    def __init__(self, block_expansion, num_kp, num_channels, max_features,
                 ...
                 single_jacobian_map=False, pad=0, model_path=None):
        ...
        if model_path is not None:
            ...
            self.load_state_dict(ckp_kp_detector)
